...
namespace UT.SL.Helper
{
    ...
    public class DataContextFactory
    {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static TDataContext GetThreadScopedDataContext<TDataContext>(string key, string cnnString) where TDataContext : DataContext, new()
        {
            return (TDataContext)GetThreadScopedDataContextInternal(typeof(TDataContext), key, cnnString);
        }
